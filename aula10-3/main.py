...
class TodoApp(ft.Column):
    def __init__(self):
        ...
        self.tasks = ft.Column(
            scroll=ft.ScrollMode.ALWAYS, height=430)
    ...
    def before_update(self):
        ...
        for task in self.tasks.controls:
            task.visible = (
                status == "Todas" or (status == "Ativas" and task.completed == False) or (
...
# Nessa aula modificamos o tamanho da aba inicial do aplicativo e colocamos um scroll
